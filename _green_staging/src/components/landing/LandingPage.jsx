...
function HeroVisual() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm sm:max-w-none">
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[28px] border border-border bg-stage shadow-lg">
        {!failed ? (
          <video
        ...
        <div className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-black/30 px-3 py-1 text-[11px] font-medium text-stage-fg-soft backdrop-blur">
          <span className="h-1.5 w-1.5 rounded-full bg-[var(--color-stage-accent)]" />
          Live symmetry read · left vs right
        </div>
        <div className="absolute bottom-4 left-4 right-4 rounded-lg border border-white/10 bg-black/35 px-3.5 py-2.5 text-[11px] leading-relaxed text-stage-fg-soft backdrop-blur">
          468 facial landmarks tracked live, entirely on-device — nothing shown here ever leaves your browser.
        </div>
      </div>
    </div>
  );
