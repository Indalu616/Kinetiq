...
function HeroVisual() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm sm:max-w-none">
      ...
      <div
        className="relative aspect-[14/15] w-full overflow-hidden rounded-[28px] border-2 border-primary bg-stage shadow-lg"
        style={{ boxShadow: '0 0 0 4px var(--color-primary-soft), 0 20px 45px -20px var(--color-primary)' }}
      >
        {!failed ? (
          <video
