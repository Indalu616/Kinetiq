...
/**
 * Base action control for the whole app — rectangular (not pill-shaped),
...
const Button = forwardRef(function Button(
  ...
  return (
    <Comp
      ref={ref}
      className={`inline-flex select-none items-center justify-center rounded-lg font-medium transition focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed ${VARIANTS[variant]} ${SIZES[size]} ${className}`}
      {...props}
    >
      {children}
    </Comp>
