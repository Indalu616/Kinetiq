...
function HeroIllustration() {
  return (
    <div className="relative aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border border-border bg-stage shadow-md sm:max-w-none">
      <svg viewBox="0 0 320 400" className="absolute inset-0 h-full w-full">
        <g stroke="rgba(238,242,249,0.32)" strokeWidth="3" strokeLinecap="round">
          <path d="M160 70v70M160 140l-45 30M160 140l45 30M118 250l42-40 42 40M138 250l-8 80M182 250l8 80" fill="none" />
        </g>
        <path d="M160 140l45 30" stroke="#59a7ff" strokeWidth="4.5" strokeLinecap="round" fill="none" />
        <g fill="#eef2f9">
        ...
        <g transform="translate(205 170)">
          <path d="M0 0 A 32 32 0 0 1 -18 -27" stroke="#59a7ff" strokeWidth="2.5" fill="none" />
          <text x="10" y="-6" fill="#59a7ff" fontSize="13" fontFamily="Inter, sans-serif" fontWeight="600">
            97°
          </text>
        </g>

        <g transform="translate(24 24)" fill="none" stroke="rgba(238,242,249,0.4)" strokeWidth="1.6">
          <rect x="0" y="0" width="272" height="352" rx="16" />
        </g>
      </svg>

      <div className="absolute left-4 top-4 rounded-full border border-white/15 bg-black/30 px-3 py-1 text-[11px] font-medium text-stage-fg-soft backdrop-blur">
        Rep 4 · left/right compared
      </div>
      <div className="absolute bottom-4 left-4 right-4 rounded-lg border border-white/10 bg-black/35 px-3.5 py-2.5 text-[11px] leading-relaxed text-stage-fg-soft backdrop-blur">
        33 body landmarks tracked live, entirely on-device — nothing shown here ever leaves your browser.
      </div>
    </div>
  );
}
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg text-ink-soft transition hover:bg-surface-hover hover:text-ink"
          >
